              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-600/30 to-brand-800/30 border border-brand-500/20 flex items-center justify-center text-lg shrink-0">
                      🚛
                    </div>
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 rounded-xl py-2 text-xs font-medium bg-brand-900/20 border border-brand-700/20 text-brand-400 hover:bg-brand-900/40 hover:text-brand-300 transition-all"
                  >
                    📄 Docs
                  </button>
                  <button
